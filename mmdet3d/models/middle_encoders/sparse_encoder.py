...
from mmdet3d.models.middle_encoders.voxel_generation import Voxel_Generation
...
class SparseEncoder(nn.Module):
    ...
    def __init__(self,
                 ...
                 vx_config=dict(lidar_channels=128)):
        super().__init__()
        ...
        self.conv_out_to_bev = make_sparse_convmodule(
            encoder_out_channels,
            self.output_channels,
            kernel_size=(2, 1, 1),
            stride=(1, 1, 1),
        ...
        # curve_template_path = '/home/guowen_zhang/code/iccv_tune/BEVDiffuse/data/curve/curve_template_3d_rank_8_trun.pth'
    ...
    def forward(self, voxel_features, coors, batch_size, img_feats=None,
                img_input_list=None, oracle_gt_bboxes_3d=None, oracle_mode=None):
        ...
        # for detection head
        # [200, 176, 5] -> [200, 176, 2]
        # featAR = encode_features[-1]
        # batch = featAR.indices[:, 0].max().item() + 1
        # featAR = self.mamba_autoRegression(featAR, batch)
        # out = self.conv_out(featAR)
        ...
        return spatial_features, pred_bev_mask
