...
model = dict(
    ...
    pts_middle_encoder=dict(
        ...
        vx_config=dict(
            fg_thr=0.4,
            curve_rank=8,
            curve_template_path='/home/guowen/Multimodal/OpenCode_AAAI/BEVDilation/curve_template_2d_rank_8.pth',
            img_channels=32,
            lidar_channels=192,
...
load_from = '/home/guowen/code/BEVDet/pretrained_models/r50_fpn_nuImage_pretrained.pth'